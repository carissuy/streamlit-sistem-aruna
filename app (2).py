...
with tab_main:
    ...
    with st.spinner("Sistem sedang memproses algoritma dan merender grafik..."):
        ...
        if end_user > today_date:
            ...
            # Potong output agar presisi masuk dalam koridor range kalender user (DENGAN perbaikan .date() )
...
with tab_eval:
    ...
    st.success(f"✔ **Kesimpulan Evaluasi Keandalan:** Grafik evaluasi menunjukkan tingkat kerapatan yang sangat tinggi antara kurva aktual and prediksi dengan Akurasi mencapai **{model_acc:.2f}%**. Hal ini secara formal membuktikan algoritma program komputer layak didaftarkan HKI karena memiliki tingkat akurasi yang valid.")
